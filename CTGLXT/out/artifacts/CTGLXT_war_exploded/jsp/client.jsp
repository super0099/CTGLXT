...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="${ctx}/static/css/Chome.css">
</head>
<body>
<div class="content">
    <button type="button" class="Wmethod" id="Wmethod" onclick="go()">
        <p>外卖</p>
    </button>
    <button type="button" class="Nmethod" id="Nmethod" onclick="leave()">
        <p>店内</p>
    </button>
</div>
...
<script>
function go(){
    window.location.replace("${ctx}/takeout");
}
function leave(){
    window.location.replace("${ctx}/shop");
}
</script>
</body>
</html>
