...
<div>
    <ul class="layui-tab-title">
        <li class="home">
            <i class="layui-icon">&#xe68e;</i>办理入住
        </li>
    </ul>
</div>
<div class="layui-tab layui-tab-card big">
    <ul class="layui-tab-title">
        <li class="layui-this" onclick="selectAlready(1)" value="1">已预约</li>
        <li onclick="selectAlready(2)" value="2">未预约</li>
    </ul>
    <div class="already" id="already" style="display: block;">
        <div class="leftBox" style="height: 96%">
            <div class="leftTitle"><span>待入职长者信息</span></div>
            <div class="leftBody">
                <div class="leftBodyTitle layui-row">
                    <ul>
                        <li class="layui-col-md1">&nbsp;</li>
                        <li class="layui-col-md4">入住Id</li>
        ...
        <div class="rightBox" style="height: 96%">
    ...
    <div class="didNot" id="didNot" style="display: none;">
        <div class="jump">
            <button onclick="openWin()">前往预约</button>
        </div>
    </div>
</div>
...
<script>
    $(function (){
        $.post("${ctx}/await/selectAwaitElderAll",{},function (jsonData){
            ...
            for (var i =0;i<jsonData.length;i++){
                leftBodyBody.innerHTML+='<ul onclick="selectElder('+jsonData[i].id+')" class="clearfix"><li class="layui-col-md1"><i class="layui-icon">&#xe602;</i></li><li class="layui-col-md4">'+jsonData[i].id+'</li><li class="layui-col-md3">'+jsonData[i].elderName+'</li><li class="layui-col-md4">&nbsp;</li></ul>';
            }
        })
    });
    ...
    function openWin(){
        window.location.href="${ctx}/reception/appointment";
    }
</script>
</body>
</html>
